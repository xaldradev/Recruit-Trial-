...
import { Send, Bot, User, Sparkles, Plus, RefreshCw, Trash2, Mic, Paperclip, CheckCircle, ArrowRight, Lightbulb, MapPin, Briefcase, Landmark, Award, Minus, X, Globe, Phone, History, BookOpen, FileText, ExternalLink, GraduationCap, Users } from 'lucide-react';
...
const SITE_PRODUCTS = [
  {
    ...
    price: '₹799',
    badge: 'Coding Lab',
    description: 'Learn modern web development with an interactive workspace and expert-led labs.',
    tab: 'courses',
    keywords: ['full-stack javascript', 'javascript', 'typescript', 'fullstack-js', 'coding lab', 'web development']
  },
  {
    id: 'aws-cloud',
    type: 'course',
    ...
    description: 'Master cloud fundamentals, serverless systems, and clear the official AWS exam.',
    tab: 'courses',
    keywords: ['aws certified', 'aws cloud', 'cloud practitioner', 'aws-cloud', 'amazon web services']
  },
  {
    id: 'python-ai',
    type: 'course',
    ...
    price: '₹499',
    badge: 'Scripting',
    description: 'Learn automation script pipelines, scrapers, and foundational Python APIs.',
    tab: 'courses',
    keywords: ['python for beginners', 'script automation', 'python-ai', 'learn python', 'automation scripting']
  },
  {
    id: 'cyber-sec',
    type: 'course',
    ...
    description: 'Protect application gateways, audit networks, and discover security gaps.',
    tab: 'courses',
    keywords: ['cyber security', 'ethical hacking', 'cyber-sec', 'vulnerability audit', 'network security']
  },
  {
    id: 'data-analytics',
    type: 'course',
    ...
    price: '₹449',
    badge: 'Data Science',
    description: 'Process and analyze large datasets, model charts, and master Power BI dashboards.',
    tab: 'courses',
    keywords: ['data science', 'power bi', 'data analytics', 'data-analytics', 'business intelligence']
  },
  {
    id: 'mobile-flutter',
    type: 'course',
    ...
    description: 'Deploy beautiful cross-platform hybrid applications for iOS and Android devices.',
    tab: 'courses',
    keywords: ['mobile app development', 'flutter', 'dart coding', 'mobile-flutter', 'cross-platform']
  },
  {
    id: 'ui-ux-design',
    type: 'course',
    ...
    price: '₹399',
    badge: 'Figma Design',
    description: 'Create wires, interactive flow prototype assets, and professional design frameworks.',
    tab: 'courses',
    keywords: ['ui/ux design', 'figma masterclass', 'ui-ux-design', 'wireframe UI', 'design prototypes']
  },
  {
    id: 'sql-db-admin',
    type: 'course',
    ...
    description: 'Manage relational structures, PostgreSQL keys, and NoSQL MongoDB document stores.',
    tab: 'courses',
    keywords: ['database management', 'sql database', 'postgres database', 'mongodb admin', 'sql-db-admin']
  },
  {
    id: 'salesforce-admin',
    type: 'course',
    ...
    description: 'Learn custom cloud workflows, profiles, reporting boards, and CRM governance.',
    tab: 'courses',
    keywords: ['salesforce administrator', 'crm workflows', 'salesforce-admin', 'salesforce certification']
  },
  {
    id: 'java-enterprise',
    type: 'course',
    ...
    description: 'Create multi-tiered enterprise servers, databases, and secure Spring controllers.',
    tab: 'courses',
    keywords: ['java enterprise', 'spring boot web', 'java-enterprise', 'enterprise microservices']
  },
  {
    id: 'resume-suite',
    type: 'service',
    title: 'Premium AI Resume Builder & ATS Analyzer',
    price: 'Free Tool',
    badge: 'Smart CV Suite',
    description: 'Compile stunning corporate resumes to Word .docx format and calculate your ATS match score.',
    tab: 'resume',
    keywords: ['resume builder', 'ats analyzer', 'ats resume', 'resume tool', 'professional cv', 'improve resume', 'upload resume', 'resume', 'cv']
  },
  {
    id: 'interview-prep',
    type: 'service',
    title: 'AI Behavioral & Tech Interview Prep Console',
    price: 'Free Tool',
    badge: 'Mock Audits',
    description: 'Practice real-time text & voice simulations with instant expert evaluation scores.',
    tab: 'interview',
    keywords: ['interview prep', 'mock interview', 'interview console', 'interview preparation', 'behavioral interview', 'interview']
  },
  {
    id: 'business-suite',
    type: 'service',
    title: 'Interactive Startup Roadmaps & Mudra Loan Checks',
    price: 'Free Tool',
    badge: 'MSME Business',
    description: 'Generate step-by-step business blueprints, test ideas, and check Mudra eligibility criteria.',
    tab: 'business',
    keywords: ['business roadmaps', 'startup planner', 'mudra loan', 'business plan', 'starting business', 'entrepreneurship', 'business']
  },
  {
    id: 'franchise-hub',
    type: 'service',
  ...
  },
  {
    id: 'schemes-finder',
    type: 'service',
    title: 'Central & State Government Schemes Finder',
    price: 'Free Tool',
    badge: 'Govt Benefits',
    description: 'Discover subsidies, farmers aid, women grants, and student scholarships with smart matching.',
    tab: 'schemes',
    keywords: ['government schemes', 'state schemes', 'scheme finder', 'pm mudra scheme', 'pm-kisan scheme', 'schemes', 'scheme']
  },
  {
    id: 'school-syllabus',
    type: 'service',
    title: 'Board Exam NCERT Planners & Syllabus Tracker',
    price: 'Free Access',
    badge: 'School & K-12',
    description: 'Track academic progress, animated lessons, NCERT answers, and CBSE / State Board guides.',
    tab: 'school-syllabus',
    keywords: ['school syllabus', 'ncert solutions', 'board exam preparation', 'study planners', 'cbse syllabus', 'school']
  },
  {
    id: 'career-explorer',
    type: 'service',
    title: 'Predictive Assessment & Mentorship Hub',
    price: 'Free Consultation',
    badge: 'Career Pathing',
    description: 'Complete our high-accuracy predictive assessments and book 1-on-1 industry mentoring slots.',
    tab: 'career',
    keywords: ['career explorer', 'industry mentorship', 'career prediction assessment', 'career pathing', 'mentor slot', 'career']
  },
  {
    id: 'employer-portal',
    type: 'service',
    title: 'AI Employer Matching & Fast Job Posting',
    price: 'Free Posting',
    badge: 'Recruiter Suite',
    description: 'Post hiring campaigns and leverage intelligent candidate filters to land top talent.',
    tab: 'employer',
    keywords: ['employer portal', 'recruiter match', 'candidate filtering', 'hiring campaign', 'job posting', 'employer', 'hiring']
  }
];

function detectRecommendedProducts(content: string) {
  const lowercase = content.toLowerCase();
  const found: typeof SITE_PRODUCTS = [];
  
  for (const prod of SITE_PRODUCTS) {
    const isMatched = prod.keywords.some(keyword => lowercase.includes(keyword));
    if (isMatched) {
      found.push(prod);
    }
  }
  
  // Return at most 2 products to keep the chat elegant and not cluttered
  return found.slice(0, 2);
}

function getProductIcon(tab: string) {
  switch (tab) {
    case 'courses':
            ...
            return (
              ...
              >
                ...
                <div className={`max-w-[85%] md:max-w-[75%] rounded-2xl p-4 shadow-md leading-relaxed text-sm ${
                  ...
                  {msg.role === 'assistant' && (() => {
                    const recommendedProducts = detectRecommendedProducts(parsed.cleanedContent);
                    if (recommendedProducts.length === 0) return null;
                    return (
                      <div className="mt-4 pt-4 border-t border-[#2a205a]/60 text-left">
                        <div className="flex items-center gap-1.5 mb-2.5">
                          <Sparkles className="w-3.5 h-3.5 text-[#ffb74d] animate-pulse" />
                          <span className="text-[10px] font-black uppercase tracking-wider text-[#a78bfa]">
                            AROHI Suggestions ({recommendedProducts.length})
                          </span>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {recommendedProducts.map((prod) => (
                            <div
                              ...
                              onClick={() => {
                                if (onNavigateTab) {
                                  onNavigateTab(prod.tab);
                                }
                              }}
                              className="group flex flex-col justify-between bg-[#19143d]/85 hover:bg-[#231b54]/95 border border-[#4c3ba0]/50 hover:border-[#7c3aed]/80 rounded-xl p-3.5 transition-all duration-200 cursor-pointer shadow-md hover:shadow-[0_4px_15px_rgba(124,58,237,0.2)] transform active:scale-[0.98]"
                            >
                              <div>
                                <div className="flex items-start justify-between gap-2 mb-1.5">
                                  <div className="p-1.5 bg-[#7c3aed]/20 rounded-lg border border-[#7c3aed]/30 group-hover:bg-[#7c3aed]/30 transition-colors shrink-0">
                                    {getProductIcon(prod.tab)}
                                  </div>
                                  {prod.badge && (
                                    <span className="bg-[#7c3aed]/20 text-[#c084fc] text-[8px] px-1.5 py-0.5 rounded-full font-black uppercase tracking-wider border border-[#7c3aed]/35 shrink-0">
                                      {prod.badge}
                                    </span>
                                  )}
                                </div>
                                <h5 className="text-xs font-bold text-white group-hover:text-[#c084fc] transition-colors leading-snug line-clamp-2">
                                  {prod.title}
                                </h5>
                                <p className="text-[10px] text-slate-300 mt-1 leading-relaxed line-clamp-2 group-hover:text-slate-100 transition-colors">
                                  {prod.description}
                                </p>
                              </div>
                              
                              <div className="flex items-center justify-between border-t border-[#31256b]/50 pt-2.5 mt-3">
                                {prod.price && (
                                  <span className="text-xs font-black text-emerald-400">
                                    {prod.price}
                                  </span>
                                )}
                                <span className="text-[9px] uppercase font-black tracking-widest text-[#a78bfa] group-hover:text-white flex items-center gap-1 transition-all">
                                  Access Now <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
                                </span>
                              </div>
                            </div>
                          ))}
